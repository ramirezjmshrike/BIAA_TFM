...
- `source/`: Esta carpeta contiene los notebooks correspondientes a todos los experimentos realizados. Cada carpeta corresponde a un entorno de Python distinto, autocontenido y específico para cada experimentos y, por lo tanto, también cuenta con su correspondiente fichero `requirements.txt`:
  ...
  - `source/03_HRNet`: Contiene los notebooks y demás código del modelo HRNet preentrenado con el dataset Cityscapes con el que experimentamos su capacidad para generalizar en el dominio peatonal de Barcelona y su área metropolitana.
